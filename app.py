...
def filter_description():
	...
	return "<h3>Filter: " + filter + "</h3><p>" + filter_json["description"] + " To see the weights for each metric click <a href=\"https://comparedtowhat.azurewebsites.net/filter-weights?filter=" + filter + "\">here</a>.</p>"
